...
@Component({
  selector: 'app-ior-view-form',
  imports: [ButtonComponent, CommonModule],
  providers: [DatePipe],
  templateUrl: './ior-view-form.component.html',
  styleUrl: './ior-view-form.component.css'
})
export class IorViewFormComponent implements OnInit {
