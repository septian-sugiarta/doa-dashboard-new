...
@Component({
  selector: 'app-ncr-view-easa-reply',
  imports: [ButtonComponent, CommonModule],
  providers: [DatePipe],
  templateUrl: './ncr-view-easa-reply.component.html',
  styleUrl: './ncr-view-easa-reply.component.css'
})
export class NcrViewEasaReplyComponent implements OnInit {
  data: {
