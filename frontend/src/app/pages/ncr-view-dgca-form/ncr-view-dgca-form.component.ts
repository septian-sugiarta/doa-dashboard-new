...
@Component({
  selector: 'app-ncr-view-dgca-form',
  imports: [ButtonComponent, CommonModule],
  providers: [DatePipe],
  templateUrl: './ncr-view-dgca-form.component.html',
  styleUrl: './ncr-view-dgca-form.component.css'
})
export class NcrViewDgcaFormComponent implements OnInit {
  data: {
