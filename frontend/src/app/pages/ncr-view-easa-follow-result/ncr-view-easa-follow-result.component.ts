...
@Component({
  selector: 'app-ncr-view-easa-follow-result',
  imports: [ButtonComponent, CommonModule],
  providers: [DatePipe],
  templateUrl: './ncr-view-easa-follow-result.component.html',
  styleUrl: './ncr-view-easa-follow-result.component.css'
})
export class NcrViewEasaFollowResultComponent implements OnInit {
  data: {
